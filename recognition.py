...
def main():
    ...
    # Train the model
    history = train_activity_recognition_model(model, train_generator, val_generator, epochs=10, batch_size=32)
    if history is None:
    ...
    image_path = '/Users/rohithr/Desktop/volvo_project/dummy_dataset/simple_images/volvo construction bulldozer/volvo construction bulldozer_15.jpg'
